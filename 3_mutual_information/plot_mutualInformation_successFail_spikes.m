function [] = plot_mutualInformation_successFail_spikes(MIsuccessFail,MIorig,clusterParams,f2plot,save_params,params,newBinTimes)
...
%%% ORGINAL
    ...
    %%% PLOT INFO CASCADES AND MEAN / SEM
        ...
        figure('units','normalized','outerposition',[0 0 1 1])
            ...
            subplot(3,2,6); hold on;
                ...
                if save_params.save == 1
                    print([save_params.save_path '\Spikes_information_' params.reachFeatures{fidx} '_cascade_plot_mean_sem.eps'],'-painters','-depsc');
                end   
        ...
        figure('units','normalized','outerposition',[0 0 1 1])
            clearvars g
                ...
                g(1,1).axe_property('YLim',[0 0.02]);           
                ...
                g(1,2).axe_property('YLim',[0 0.02]);     
                g(1,2).set_title('dls lfp information');        
                g.draw();
                if save_params.save == 1
                    print([save_params.save_path '\Spikes_information_' params.reachFeatures{fidx} '_mean_sem.eps'],'-painters','-depsc');
                end   
    ...
    %%% PEAK SHIFT INFO
        ...
        figure('units','normalized','outerposition',[0 0 1 1]);
            ...
            g.draw();
            if save_params.save == 1
                print([save_params.save_path '\Spikes_information_M1_' params.reachFeatures{fidx} '_timingShift.eps'],'-painters','-depsc');
            end
        ...
        figure('units','normalized','outerposition',[0 0 1 1]);
            ...
            g.draw();
            if save_params.save == 1
                print([save_params.save_path '\Spikes_information_DLS_' params.reachFeatures{fidx} '_timingShift.eps'],'-painters','-depsc');
            end
    ...
    %%% NEW NAIVE SKILLED COMPARISON HISTOGRAM/CDF
        ...
        figure;
            ...
            subplot(2,2,4);
                ...
                grid off;
            if save_params.save == 1
                print([save_params.save_path '\Spikes_information_new_skilled_' params.reachFeatures{fidx} '.eps'],'-painters','-depsc');
            end
