function [] = plot_mutualInformation_Spikes_comparison_newChan_allFeatures(MIout,LFP_early_late,params,clusterParams,save_params,newBinTimes)
...
figure;
    ...
    if save_params.save == 1
        print([save_params.save_path '\allFeature_Info_M1_Spikes.eps'],'-painters','-depsc');
    end
...
figure;
    ...
    sgtitle('DLS Spikes')
    if save_params.save == 1
        print([save_params.save_path '\allFeature_Info_DLS_Spikes.eps'],'-painters','-depsc');
    end
...
figure;
    ...
    if save_params.save == 1
        print([save_params.save_path '\spikes_info_niave_skilled_spikes.eps'],'-painters','-depsc');
    end   
...
% 
%         if save_params.save == 1
%             print([save_params.save_path '\allFeature_Info' params.reachFeatures{fidx} '_SPIKES.eps'],'-painters','-depsc');
%         end
