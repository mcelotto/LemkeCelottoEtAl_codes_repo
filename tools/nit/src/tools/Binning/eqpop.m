...
edges = edges-1;
edges(1) = 1;
% edges = 0:binSize:length(X);
% edges(end) = length(X); % in case number of elements is not perfect multiple of number of bins, make sure that last bin always matches with the elements count
% edges(1) = 1;
