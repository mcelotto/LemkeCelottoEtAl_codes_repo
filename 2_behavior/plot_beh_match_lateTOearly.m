function [] = plot_beh_match_lateTOearly(reachFeatures_early_late_noBinNoTrialMatch,reachFeatures_early_late_noBin,params,animals_to_run,features_to_run,plot_params)
...
%         end
    ...
    if fidx==9
        figure;
            subplot(1,2,1); hold on;
                histogram(all_early_all,[0:0.2:3],'DisplayStyle','Stairs');
                histogram(all_late_all,[0:0.2:3],'DisplayStyle','Stairs');
                [h p] = kstest2(all_early_all,all_late_all);
                title(['kstest: p = ' num2str(p) '|  trials: ' num2str(length(all_early_all))])
                ylim([1 500])
            subplot(1,2,2); hold on;
                histogram(all_early_match,[0:0.2:3],'DisplayStyle','Stairs');
                histogram(all_late_match,[0:0.2:3],'DisplayStyle','Stairs');
    ...
    elseif fidx==13
        figure;
            subplot(1,2,1); hold on;
                histogram(all_early_all,[0:20:440],'DisplayStyle','Stairs');
                histogram(all_late_all,[0:20:440],'DisplayStyle','Stairs');
                [h p] = kstest2(all_early_all,all_late_all);
                title(['kstest: p = ' num2str(p) '|  trials: ' num2str(length(all_early_all))])                  
                ylim([1 250])
            subplot(1,2,2); hold on;
                histogram(all_early_match,[0:20:440],'DisplayStyle','Stairs');
                histogram(all_late_match,[0:20:440],'DisplayStyle','Stairs');
                [h p] = kstest2(all_early_match,all_late_match);
                title(['kstest: p = ' num2str(p) '|  trials: ' num2str(length(all_early_match))])  
                ylim([1 250])            
            sgtitle(['matched early TO late | ' params.reachFeatures{fidx}])  
    ...
    elseif fidx==12
        figure;
            subplot(1,2,1); hold on;
                histogram(all_early_all,[0:50:800],'DisplayStyle','Stairs');
                histogram(all_late_all,[0:50:800],'DisplayStyle','Stairs');
                [h p] = kstest2(all_early_all,all_late_all);
                title(['kstest: p = ' num2str(p) '|  trials: ' num2str(length(all_early_all))])   
                ylim([1 500])                            
            subplot(1,2,2); hold on;
                histogram(all_early_match,[0:50:800],'DisplayStyle','Stairs');
                histogram(all_late_match,[0:50:800],'DisplayStyle','Stairs');
                [h p] = kstest2(all_early_match,all_late_match);
                title(['kstest: p = ' num2str(p) '|  trials: ' num2str(length(all_early_match))])   
                ylim([1 500])                                            
            sgtitle(['matched early TO late | ' params.reachFeatures{fidx}])                
