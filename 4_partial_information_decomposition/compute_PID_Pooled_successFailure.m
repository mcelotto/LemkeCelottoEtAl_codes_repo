function [PIDout] = compute_PID_Pooled_successFailure(LFP_early_late, reachFeatures_early_late, params, PID_params, tMin, binSize, animals_to_run,features_to_run)
...
if PID_params.doLFPearlylate==1
    for animal = animals_to_run
        ...
        if PID_params.savePID
            save([PID_params.save_path '\PID_' params.animals{animal} '_' (features_to_run{fidx}) '_' date ...
